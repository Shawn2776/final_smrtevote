...
const ProtectedNavbar = () => {
  ...
  return (
    <header className="flex items-center w-full h-20 px-4 mb-10 text-black bg-white lg:mb-0 shrink-0 md:px-6">
      {/* MOBILE */}
      <Sheet>
        ...
        <SheetContent side="right">
          ...
          <hr className="pb-4 border-gray-200 dark:border-gray-800" />
...
// return (
//   <nav className="flex items-center justify-between w-full p-4 mx-auto mb-10 border-b lg:mb-0 max-w-7xl">
