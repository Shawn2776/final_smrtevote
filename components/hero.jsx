...
const Hero = () => {
  return (
    <section className="bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-400 to-blue-800 text-gray-800">
      <div className="max-w-7xl container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <div className="flex flex-col">
              <a
                ...
                href="/auth/register"
                className="px-8 py-3 text-lg font-semibold rounded bg-white text-black shadow-md shadow-black"
              >
                Get Started
              </a>
